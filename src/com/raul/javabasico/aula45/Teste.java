...
public class Teste {
	...
	public static void main(String[] args) {
		...
		if(contaSimples instanceof ContaBancaria) {
			System.out.println("\nConta Simples é uma instancia de ContaBancaria");
		}
		if(contaPoupanca instanceof ContaPoupanca) {
			System.out.println("\nConta Poupança é uma instancia de ContaPoupanca");
		}
		if(contaEspecial instanceof ContaEspecial) {
			System.out.println("\nConta Especial é uma instancia de ContaEspecial");
		}
		if(contaEspecial instanceof ContaBancaria) {
			System.out.println("\nConta Especial é uma instancia de ContaBancaria");
		}
	}
